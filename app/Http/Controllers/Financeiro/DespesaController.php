...
class DespesaController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        // Obtém apenas as categorias de 'despesa' para o filtro
        $categorias = Categoria::where('tipo', 'despesa')->orderBy('nome')->get();

        return view('financeiro.despesas.index', compact('despesas', 'categorias', 'request'));
    }
    ...
    {
        // Obtém apenas as categorias de 'despesa'
        $categorias = Categoria::where('tipo', 'despesa')->orderBy('nome')->get();
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('financeiro.despesas.index')->with('success', 'Despesa cadastrada com sucesso!');
        } catch (\Exception $e) {
            \Log::error('Erro ao cadastrar despesa: ' . $e->getMessage(), ['request_data' => $request->all()]);
            return redirect()->back()->withInput()->with('error', 'Erro ao cadastrar a despesa: ' . $e->getMessage());
        }
    }
