...
<!-- Content Header (Page header) -->
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Editar Incubação: #<?php echo e($incubacao->id); ?></h1>
                    </div>
                    <div class="col-sm-6">
...
unset($__errorArgs, $__bag); ?>" required>
                                            ...
                                            <?php $__currentLoopData = $tiposAves; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tipoAve): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($tipoAve->id); ?>" <?php echo e(old('tipo_ave_id', $incubacao->tipo_ave_id) == $tipoAve->id ? 'selected' : ''); ?> data-tempo-eclosao="<?php echo e($tipoAve->tempo_eclosao ?? 0); ?>"><?php echo e($tipoAve->nome); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
...
unset($__errorArgs, $__bag); ?>">
                                            ...
                                            <?php $__currentLoopData = $lotes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lote): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($lote->id); ?>" <?php echo e(old('lote_ovos_id', $incubacao->lote_ovos_id) == $lote->id ? 'selected' : ''); ?>><?php echo e($lote->identificacao_lote); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
...
unset($__errorArgs, $__bag); ?>">
                                            ...
                                            <?php $__currentLoopData = $posturasOvos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $posturaOvo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <option value="<?php echo e($posturaOvo->id); ?>" <?php echo e(old('postura_ovo_id', $incubacao->postura_ovo_id) == $posturaOvo->id ? 'selected' : ''); ?>><?php echo e(optional($posturaOvo->data_inicio_postura)->format('d/m/Y') ?? 'N/A'); ?> - <?php echo e($posturaOvo->acasalamento->macho->tipoAve->nome ?? 'N/A'); ?> (<?php echo e($posturaOvo->quantidade_ovos); ?> ovos)</option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('data_entrada_incubadora', $incubacao->data_entrada_incubadora->format('Y-m-d'))); ?>" required>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('data_prevista_eclosao', $incubacao->data_prevista_eclosao->format('Y-m-d'))); ?>" required readonly>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('quantidade_ovos', $incubacao->quantidade_ovos)); ?>" min="1" required>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="quantidade_eclodidos" id="quantidade_eclodidos" class="form-control <?php $__errorArgs = ['quantidade_eclodidos'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('quantidade_eclodidos', $incubacao->quantidade_eclodidos)); ?>" min="0">
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="quantidade_inferteis" id="quantidade_inferteis" class="form-control <?php $__errorArgs = ['quantidade_inferteis'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('quantidade_inferteis', $incubacao->quantidade_inferteis)); ?>" min="0">
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="quantidade_infectados" id="quantidade_infectados" class="form-control <?php $__errorArgs = ['quantidade_infectados'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('quantidade_infectados', $incubacao->quantidade_infectados)); ?>" min="0">
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="quantidade_mortos" id="quantidade_mortos" class="form-control <?php $__errorArgs = ['quantidade_mortos'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('quantidade_mortos', $incubacao->quantidade_mortos)); ?>" min="0">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('chocadeira', $incubacao->chocadeira)); ?>" placeholder="Nome ou identificação da chocadeira">
...
unset($__errorArgs, $__bag); ?>" rows="3"><?php echo e(old('observacoes', $incubacao->observacoes)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="form-group">
                                        <div class="form-check">
                                            ...
                                            <input type="checkbox" name="ativo" id="ativo" class="form-check-input" value="1" <?php echo e(old('ativo', $incubacao->ativo) ? 'checked' : ''); ?>>
                                ...
                                <div class="card-footer">
                                    ...
                                    <a href="<?php echo e(route('incubacoes.show', $incubacao->id)); ?>" class="btn btn-secondary">Cancelar</a>
                                </div>
                            </form>
                        </div>
                        <!-- /.card -->
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/keykira/Downloads/laravel/laravel-1/resources/views/incubacoes/edit.blade.php ENDPATH**/ ?>