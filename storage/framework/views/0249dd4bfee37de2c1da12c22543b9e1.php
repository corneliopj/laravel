                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                <a href="<?php echo e(route('posturas_ovos.create')); ?>" class="btn btn-success">
                            ...
                            <div class="form-group">
                                ...
                                <select id="filter_acasalamento" class="form-control">
                                    ...
                                    <?php $__currentLoopData = $acasalamentos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $acasalamento): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($acasalamento->id); ?>" <?php echo e($acasalamentoId == $acasalamento->id ? 'selected' : ''); ?>>
                            ...
                            <table class="table table-bordered table-striped" id="posturas-table">
                                ...
                                <tbody>
                                    <?php $__empty_1 = true; $__currentLoopData = $posturasOvos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $postura): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr data-postura-id="<?php echo e($postura->id); ?>">
                                            <td><?php echo e($postura->id); ?></td>
                                            <td>
                                                M: <?php echo e($postura->acasalamento->macho->matricula ?? 'N/A'); ?> / F: <?php echo e($postura->acasalamento->femea->matricula ?? 'N/A'); ?>

                                                <br><small>(<?php echo e($postura->acasalamento->data_inicio->format('d/m/Y')); ?>)</small>
                                            </td>
                                            <td><?php echo e($postura->data_inicio_postura->format('d/m/Y')); ?></td>
                                            <td><?php echo e($postura->data_fim_postura ? $postura->data_fim_postura->format('d/m/Y') : 'Em andamento'); ?></td>
                                            <td class="quantidade-ovos-cell"><?php echo e($postura->quantidade_ovos); ?></td>
                                            <td><?php echo e($postura->observacoes ?? 'N/A'); ?></td>
                                            <td>
                                                <a href="<?php echo e(route('posturas_ovos.edit', $postura->id)); ?>" class="btn btn-sm btn-primary" title="Editar Postura">
                                                    <i class="fas fa-edit"></i>
                                                </a>
                                                
                                                <?php if(!$postura->data_fim_postura): ?>
                                                <button type="button" class="btn btn-sm btn-info toggle-increment-form" data-id="<?php echo e($postura->id); ?>" title="Adicionar Ovos">
                                                ...
                                                <?php if(!$postura->data_fim_postura): ?>
                                                <button type="button" class="btn btn-sm btn-success encerrar-postura-btn" data-id="<?php echo e($postura->id); ?>" title="Encerrar Postura e Iniciar Incubação">
                                                ...
                                                <?php if($postura->data_fim_postura): ?>
                                                <form action="<?php echo e(route('posturas_ovos.destroy', $postura->id)); ?>" method="POST" style="display:inline;">
                                                    <?php echo csrf_field(); ?>
                                        ...
                                        <tr class="increment-form-row" id="increment-form-row-<?php echo e($postura->id); ?>" style="display:none;">
                                            <td colspan="7">
                                                <div class="card card-info card-outline mb-0">
                                                    <div class="card-header">
                                                        <h3 class="card-title">Adicionar Ovos para Postura #<?php echo e($postura->id); ?></h3>
                                                    </div>
                                                    <div class="card-body">
                                                        <div class="form-group row">
                                                            <label for="quantidade_adicionar_<?php echo e($postura->id); ?>" class="col-sm-2 col-form-label">Qtd. a Adicionar:</label>
                                                            <div class="col-sm-3">
                                                                <input type="number" class="form-control form-control-sm" id="quantidade_adicionar_<?php echo e($postura->id); ?>" value="1" min="1">
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <button type="button" class="btn btn-sm btn-success increment-eggs" data-id="<?php echo e($postura->id); ?>">
...
<script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            filterAcasalamentoSelect.addEventListener('change', function() {
                ...
                let url = "<?php echo e(route('posturas_ovos.index')); ?>";
            ...
            document.querySelectorAll('.increment-eggs').forEach(button => {
                button.addEventListener('click', function() {
                    ...
                    fetch(`<?php echo e(url('posturas_ovos')); ?>/${posturaId}/increment-ovos`, {
                        method: 'POST',
                        headers: {
                            'Content-Type': 'application/json',
                            'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>' // Inclui o token CSRF
                        },
            ...
            document.getElementById('formEncerrarPostura').addEventListener('submit', function(event) {
                ...
                fetch(`<?php echo e(url('posturas_ovos')); ?>/${posturaId}/encerrar`, {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/keykira/Downloads/laravel/laravel-1/resources/views/posturas_ovos/listar.blade.php ENDPATH**/ ?>