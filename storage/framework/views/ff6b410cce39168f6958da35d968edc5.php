<div class="card card-outline card-secondary mt-3 item-row" data-index="<?php echo e($index); ?>">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group col-md-4">
                ...
                <input type="hidden" name="items[<?php echo e($index); ?>][valor_total_item]" value="<?php echo e(number_format(((float)($item['quantidade'] ?? 0)) * ((float)($item['preco_unitario'] ?? 0)), 2, '.', '')); ?>">
            </div>
        </div>
    </div>
</div>
<?php /**PATH /home/keykira/Downloads/laravel/laravel-1/resources/views/financeiro/reservas/partials/item_form_fields.blade.php ENDPATH**/ ?>