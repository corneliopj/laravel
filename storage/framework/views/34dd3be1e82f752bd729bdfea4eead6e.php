<?php
    $pageTitle = 'Registrar Nova Postura de Ovos';
?>
    ...
    <div class="content-wrapper px-4 py-2" style="min-height:797px;">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Registrar Nova Postura de Ovos</h1>
                    </div>
                    <div class="col-sm-6">
                ...
                <div class="row">
                    <div class="col-md-8"> 
                        <div class="card card-primary">
                            ...
                            <form action="<?php echo e(route('posturas_ovos.store')); ?>" method="POST">
                                <?php echo csrf_field(); ?> 
                                <div class="card-body">
...
unset($__errorArgs, $__bag); ?>" required>
                                            ...
                                            <?php $__currentLoopData = $acasalamentos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $acasalamento): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($acasalamento->id); ?>" <?php echo e(old('acasalamento_id') == $acasalamento->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" id="data_inicio_postura" value="<?php echo e(old('data_inicio_postura')); ?>" required>
...
unset($__errorArgs, $__bag); ?>" id="data_fim_postura" value="<?php echo e(old('data_fim_postura')); ?>">
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="form-group">
                                        <label for="quantidade_ovos">Quantidade Inicial de Ovos</label>
...
unset($__errorArgs, $__bag); ?>" id="quantidade_ovos" placeholder="Ex: 0" value="<?php echo e(old('quantidade_ovos', 0)); ?>" min="0" required>
                                        <small class="form-text text-muted">Esta é a quantidade inicial. Você poderá adicionar mais ovos diariamente na tela de listagem.</small>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="card-footer">
                                    <button type="submit" class="btn btn-primary">Salvar Postura</button>
...
<?php /**PATH /home/cpetersenjr.com/httpdocs/laravel/resources/views/posturas_ovos/criar.blade.php ENDPATH**/ ?>