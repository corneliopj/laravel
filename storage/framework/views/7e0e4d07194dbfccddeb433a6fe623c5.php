...
<section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Editar Reserva #<?php echo e($reserva->numero_reserva); ?></h1>
                    </div>
                    <div class="col-sm-6">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card card-primary">
                            ...
                            <form action="<?php echo e(route('financeiro.reservas.update', $reserva->id)); ?>" method="POST">
                                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" id="data_reserva" name="data_reserva" value="<?php echo e(old('data_reserva', $reserva->data_reserva->format('Y-m-d'))); ?>" required>
...
unset($__errorArgs, $__bag); ?>" id="data_prevista_entrega" name="data_prevista_entrega" value="<?php echo e(old('data_prevista_entrega', $reserva->data_prevista_entrega ? $reserva->data_prevista_entrega->format('Y-m-d') : '')); ?>">
...
unset($__errorArgs, $__bag); ?>" id="data_vencimento_proposta" name="data_vencimento_proposta" value="<?php echo e(old('data_vencimento_proposta', $reserva->data_vencimento_proposta ? $reserva->data_vencimento_proposta->format('Y-m-d') : '')); ?>">
...
unset($__errorArgs, $__bag); ?>" id="nome_cliente" name="nome_cliente" value="<?php echo e(old('nome_cliente', $reserva->nome_cliente)); ?>" placeholder="Nome completo do cliente">
...
unset($__errorArgs, $__bag); ?>" id="contato_cliente" name="contato_cliente" value="<?php echo e(old('contato_cliente', $reserva->contato_cliente)); ?>" placeholder="Telefone ou E-mail">
...
unset($__errorArgs, $__bag); ?>" id="observacoes" name="observacoes" rows="3" placeholder="Observações sobre a reserva"><?php echo e(old('observacoes', $reserva->observacoes)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" id="pagamento_parcial" name="pagamento_parcial" value="<?php echo e(old('pagamento_parcial', $reserva->pagamento_parcial)); ?>" min="0">
...
unset($__errorArgs, $__bag); ?>" required>
                                            <?php $__currentLoopData = $statusOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($key); ?>" <?php echo e(old('status', $reserva->status) == $key ? 'selected' : ''); ?>><?php echo e($value); ?></option>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div id="items-container">
                                        <?php $__currentLoopData = $reserva->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <?php if(old('items')): ?>
                                            <?php $__currentLoopData = old('items'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php if(!isset($reserva->items[$index])): ?> 
                                                    <?php echo $__env->make('financeiro.reservas.partials.item_form_fields', ['index' => $index, 'item' => $item, 'avesDisponiveis' => $avesDisponiveis], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                                                <?php endif; ?>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        <?php endif; ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/keykira/Downloads/laravel/laravel-1/resources/views/financeiro/reservas/edit.blade.php ENDPATH**/ ?>