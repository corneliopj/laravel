                ...
                <div class="row">
                    <div class="col-md-8 offset-md-2">
                        <div class="card card-primary">
                            ...
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form action="<?php echo e(route('plantel.store')); ?>" method="POST">
                                <?php echo csrf_field(); ?>
                                <div class="card-body">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('identificacao_grupo')); ?>" placeholder="Ex: Codornas Q1 2025" required>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('data_formacao', date('Y-m-d'))); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="quantidade_inicial" id="quantidade_inicial" class="form-control <?php $__errorArgs = ['quantidade_inicial'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('quantidade_inicial')); ?>" min="1" placeholder="Ex: 100" required>
                                        <?php $__errorArgs = ['quantidade_inicial'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>" rows="3" placeholder="Notas sobre o plantel..."><?php echo e(old('observacoes')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="card-footer">
                                    ...
                                    <a href="<?php echo e(route('plantel.index')); ?>" class="btn btn-secondary">Cancelar</a>
                                </div>
                            </form>
                        </div>
                        <!-- /.card -->
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/keykira/Downloads/laravel/laravel-1/resources/views/plantel/create.blade.php ENDPATH**/ ?>