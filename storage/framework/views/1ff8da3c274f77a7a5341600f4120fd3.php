    ...
    <div class="content-wrapper px-4 py-2" style="min-height: 797px;">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Ponto de Venda (PDV)</h1>
                    </div>
                    <div class="col-sm-6">
                    ...
                    <div class="col-md-12">
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title">Registrar Nova Venda</h3>
                            </div>
...
unset($__errorArgs, $__bag); ?>" id="data_venda" value="<?php echo e(old('data_venda', date('Y-m-d'))); ?>" required>
...
unset($__errorArgs, $__bag); ?>">
                                                ...
                                                <?php $__currentLoopData = $metodosPagamento; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $metodo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($metodo); ?>" <?php echo e(old('metodo_pagamento') == $metodo ? 'selected' : ''); ?>><?php echo e($metodo); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
...
unset($__errorArgs, $__bag); ?>" id="desconto" value="<?php echo e(old('desconto', 0)); ?>" min="0" step="0.01">
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="form-group">
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input" id="com_comissao" name="com_comissao" <?php echo e(old('com_comissao') ? 'checked' : ''); ?>>
...
<script>
    $(document).ready(function() {
        ...
        // Dados dos itens existentes (em caso de old input após erro de validação)
        const initialItemsData = <?php echo json_encode(old('items', []), 512) ?>; // Garante que é um array vazio se não houver old input
        ...
        function addItemToFormAndTable(descricao, quantidade, precoUnitario, aveId) {
            const currentIndex = itemIndex++; // Usa e incrementa o índice
        ...
        // Inicializa o formulário com os itens do old input (se houver)
...
<?php /**PATH /home/cpetersenjr.com/httpdocs/laravel/resources/views/financeiro/vendas/pdv.blade.php ENDPATH**/ ?>