...
<head>
    ...
    <title>Criatório Coroné | Registo</title>
...
<div class="register-box">
    ...
    <div class="card">
        <div class="card-body register-card-body">
            <p class="login-box-msg">Registar uma nova conta</p>
...
unset($__errorArgs, $__bag); ?>" placeholder="Nome Completo" value="<?php echo e(old('name')); ?>" required autofocus>
...
unset($__errorArgs, $__bag); ?>
            ...
            <a href="<?php echo e(route('login')); ?>" class="text-center">Já tenho uma conta</a>
        </div>
        </div></div>
...
<?php /**PATH /home/keykira/Downloads/laravel/laravel-1/resources/views/auth/register.blade.php ENDPATH**/ ?>