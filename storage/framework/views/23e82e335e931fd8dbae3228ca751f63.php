<?php
    $pageTitle = 'Registrar Nova Despesa';
?>
            ...
            <div class="content">
                <div class="container-fluid">
                    ...
                    <div class="card card-danger card-outline">
                        ...
                        <form action="<?php echo e(route('financeiro.despesas.store')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                            <div class="card-body">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('descricao')); ?>" placeholder="Ex: Ração, Medicamentos, Contas de Luz" required>
...
unset($__errorArgs, $__bag); ?>" rows="3" placeholder="Detalhes adicionais sobre a despesa"><?php echo e(old('observacoes')); ?></textarea>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/keykira/Downloads/laravel/laravel-1/resources/views/financeiro/despesas/create.blade.php ENDPATH**/ ?>