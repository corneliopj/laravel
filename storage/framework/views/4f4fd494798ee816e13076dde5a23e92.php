                    ...
                    <div class="card card-primary card-outline">
                        ...
                        <div class="card-body p-0">
                            <table class="table table-striped table-valign-middle">
                                ...
                                <tbody>
                                    <?php $__empty_1 = true; $__currentLoopData = $fluxoCaixaData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                            <td><?php echo e($data['mes_ano']); ?></td>
                                            <td class="text-success">R$ <?php echo e(number_format($data['total_receitas'], 2, ',', '.')); ?></td>
                                            <td class="text-danger">R$ <?php echo e(number_format($data['total_despesas'], 2, ',', '.')); ?></td>
                                            <td class="<?php echo e($data['saldo_mensal'] >= 0 ? 'text-primary' : 'text-warning'); ?>">
                                                R$ <?php echo e(number_format($data['saldo_mensal'], 2, ',', '.')); ?>
...
<script>
        $(function () {
            ...
            var fluxoCaixaChart = new Chart(ctx, {
                ...
                data: {
                    labels: <?php echo json_encode($labelsFluxoCaixa, 15, 512) ?>, // Ex: ['Jan/2023', 'Fev/2023', ...]
                    datasets: [
                        {
                            label: 'Receitas',
                            ...
                            borderWidth: 1,
                            data: <?php echo json_encode($dataReceitas, 15, 512) ?>, // Ex: [1000, 1200, ...]
                        },
                        {
                            label: 'Despesas',
                            ...
                            borderWidth: 1,
                            data: <?php echo json_encode($dataDespesas, 15, 512) ?>, // Ex: [500, 700, ...]
                        },
                        {
                            label: 'Saldo Mensal',
                            ...
                            fill: true,
                            data: <?php echo json_encode($dataSaldo, 15, 512) ?>, // Ex: [500, 500, ...]
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/keykira/Downloads/laravel/laravel-1/resources/views/financeiro/relatorios/fluxo_caixa.blade.php ENDPATH**/ ?>