...
<div class="wrapper">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="comissao_percentual" id="comissao_percentual" class="form-control @error('comissao_percentual') is-invalid @enderror" value="{{ old('comissao_percentual', $venda->comissao_percentual) }}" min="0" max="100" step="0.01">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <p id="valor_comissao_display" class="form-control-static">R$ {{ number_format($venda->valor_comissao, 2, ',', '.') }}</p>
                                            </div>
                                            @if ($venda->user)
                                                <div class="form-group">
                                    ...
                                    <div id="items_container">
                                        ...
                                        @if (old('items'))
                                            ...
                                            @endforeach
                                        @else
                                            @foreach ($venda->vendaItems ?? collect() as $index => $item)
                                                @include('financeiro.vendas.partials.item_row', [
                                                    'index' => $index,
                                                    'item' => $item,
                                                    'avesDisponiveis' => $avesDisponiveis,
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 offset-md-6">
                                            ...
                                            <div class="d-flex justify-content-between">
                                                ...
                                                <span id="comissao_display">R$ {{ number_format($venda->valor_comissao, 2, ',', '.') }}</span>
                                            </div>
                                            <div class="d-flex justify-content-between">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            let itemIndex = {{ old('items') ? count(old('items')) : ($venda->vendaItems->count() ?? 0) }};
