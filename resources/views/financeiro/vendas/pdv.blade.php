                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="date" name="data_venda" class="form-control @error('data_venda') is-invalid @enderror" id="data_venda" value="{{ old('data_venda', date('Y-m-d')) }}" required>
                                            @error('data_venda')
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <select name="metodo_pagamento" id="metodo_pagamento" class="form-control @error('metodo_pagamento') is-invalid @enderror">
                                                ...
                                                @foreach ($metodosPagamento as $metodo)
                                                    <option value="{{ $metodo }}" {{ old('metodo_pagamento') == $metodo ? 'selected' : '' }}>{{ $metodo }}</option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="number" name="desconto" class="form-control @error('desconto') is-invalid @enderror" id="desconto" value="{{ old('desconto', 0) }}" min="0" step="0.01">
                                            @error('desconto')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="form-group">
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input" id="com_comissao" name="com_comissao" {{ old('com_comissao') ? 'checked' : '' }}>
...
<script>
    $(document).ready(function() {
        ...
        const initialItemsData = @json(old('items', [])); // Garante que é um array vazio se não houver old input
