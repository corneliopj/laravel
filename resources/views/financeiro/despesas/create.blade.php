                        ...
                        <form action="{{ route('financeiro.despesas.store') }}" method="POST">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="descricao" id="descricao" class="form-control @error('descricao') is-invalid @enderror" value="{{ old('descricao') }}" placeholder="Ex: Ração, Medicamentos, Contas de Luz" required>
                                    @error('descricao')
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="observacoes" id="observacoes" class="form-control @error('observacoes') is-invalid @enderror" rows="3" placeholder="Detalhes adicionais sobre a despesa">{{ old('observacoes') }}</textarea>
                                    @error('observacoes')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
