                ...
                <div class="row">
                    <div class="col-md-6"> {{-- Reduzindo a largura do formulário --}}
                        <div class="card card-primary">
                            ...
                            <form action="{{ route('tipos_aves.store') }}" method="POST">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nome" class="form-control @error('nome') is-invalid @enderror" id="nome" placeholder="Ex: Galo de Campina, Canário, Bicudo" value="{{ old('nome') }}" required autofocus>
                                        @error('nome')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="tempo_eclosao" class="form-control @error('tempo_eclosao') is-invalid @enderror" id="tempo_eclosao" placeholder="Ex: 21 (para galinhas)" value="{{ old('tempo_eclosao') }}" min="1">
                                        @error('tempo_eclosao')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
