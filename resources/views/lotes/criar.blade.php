                            ...
                            <form action="{{ route('lotes.store') }}" method="POST">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="identificacao_lote" class="form-control @error('identificacao_lote') is-invalid @enderror" id="identificacao_lote" placeholder="Ex: Lote 2024A, Lote de Canários" value="{{ old('identificacao_lote') }}" required autofocus>
