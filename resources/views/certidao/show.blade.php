    ...
    <div class="certidao-container">
        ...
        <div class="validation-section">
            <div class="validation-code">
                Código de Validação: {{ $ave->codigo_validacao_certidao ?? 'N/A' }}
            </div>
    ...
    <script type="text/javascript">
        window.onload = function() {
            ...
            if (qrCodeDiv) {
                ...
                var validationCode = "{{ $ave->codigo_validacao_certidao ?? '' }}";
                if (validationCode) {
                    // Gerando a URL da rota pública certidao.show com o código de validação
                    var qrCodeUrl = "{{ route('certidao.show', ['validation_code' => ($ave->codigo_validacao_certidao ?? '')], true) }}";
