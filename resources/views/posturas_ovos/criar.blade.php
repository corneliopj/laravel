                            ...
                            <form action="{{ route('incubacoes.store') }}" method="POST">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control @error('quantidade_eclodidos') is-invalid @enderror" id="quantidade_eclodidos" name="quantidade_eclodidos" value="{{ old('quantidade_eclodidos', 0) }}" min="0" required>
                                    ...
                                    <div class="form-group">
                                        <div class="custom-control custom-switch">
                                            <input type="checkbox" class="custom-control-input" id="ativo" name="ativo" value="1" {{ old('ativo', 1) ? 'checked' : '' }}>
